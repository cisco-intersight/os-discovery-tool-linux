    ...
    spec:
      ...
      containers:
        - name: ucs-tool-container
          ...
          image: docker.io/intersight/ucs-tool:1.0.5
...
pull the docker image: `podman pull docker.io/intersight/ucs-tool:1.0.5`
...
run the container using the command: `podman run --rm --privileged -d -v /etc/os-release:/etc/os-release -v /lib/modules:/lib/modules docker.io/intersight/ucs-tool:1.0.5`
